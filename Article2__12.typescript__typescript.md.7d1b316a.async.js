...
// type MainID = "ID-MY_APP"`,lang:"js"}),e.a.createElement("h4",{id:"lowercase"},e.a.createElement(n.AnchorLink,{to:"#lowercase","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"Lowercase"),e.a.createElement(t.a,{code:`type Greeting = "Hello, world"
type QuietGreeting = Lowercase<Greeting>
// type QuietGreeting = "hello, world"

type ASCIICacheKey<Str extends string> = \`id-\${Lowercase<Str>}\`
type MainID = ASCIICacheKey<"MY_APP">
// type MainID = "id-my_app"`,lang:"js"}),e.a.createElement("h4",{id:"capitalize"},e.a.createElement(n.AnchorLink,{to:"#capitalize","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"Capitalize"),e.a.createElement(t.a,{code:`# Capitalize \u5B57\u7B26\u4E32\u7684\u7B2C\u4E00\u4E2A\u5B57\u7B26\u8F6C\u4E3A\u5927\u5199\u5F62\u5F0F
type LowercaseGreeting = "hello, world";
type Greeting = Capitalize<LowercaseGreeting>;
// type Greeting = "Hello, world"`,lang:"js"}),e.a.createElement("h4",{id:"uncapitalize"},e.a.createElement(n.AnchorLink,{to:"#uncapitalize","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"Uncapitalize"),e.a.createElement(t.a,{code:`# Uncapitalize
type UppercaseGreeting = "HELLO WORLD";
type UncomfortableGreeting = Uncapitalize<UppercaseGreeting>;
// type UncomfortableGreeting = "hELLO WORLD"`,lang:"js"}),e.a.createElement("h3",{id:"\u6A21\u677F\u5B57\u9762\u91CF"},e.a.createElement(n.AnchorLink,{to:"#\u6A21\u677F\u5B57\u9762\u91CF","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"\u6A21\u677F\u5B57\u9762\u91CF"),e.a.createElement(t.a,{code:'type World = "world";\ntype Greeting = `hello ${World}`;\n// type Greeting = "hello world"\n# \u5982\u679C\u662F\u8054\u5408\u7C7B\u578B \u5C31\u4F1A\u6709\u591A\u79CD\u53EF\u80FD',lang:"js"}),e.a.createElement("ul",null,e.a.createElement("li",null,"as")),e.a.createElement(t.a,{code:`// \u901A\u8FC7\u6A21\u677F\u5B57\u9762\u91CF\u521B\u5EFA\u4E00\u4E2A\u65B0\u5C5E\u6027\u540D
type Getters<Type> = {
...
# \u751F\u6210\u5B57\u7B26\u4E32\u7684\u8054\u5408\u7C7B\u578B
type xxx = keyof \u63A5\u53E3
type xxx = keyof typeof \u53D8\u91CF(enum)`,lang:"js"}),e.a.createElement("ul",null,e.a.createElement("li",null,"\u7D22\u5F15\u8BBF\u95EE\u7C7B\u578B")),e.a.createElement(t.a,{code:`# \u751F\u6210value
...
// type Age2 = number`,lang:"js"}),e.a.createElement("h3",{id:"infer"},e.a.createElement(n.AnchorLink,{to:"#infer","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"infer"),e.a.createElement("ul",null,e.a.createElement("li",null,"\u6761\u4EF6\u7C7B\u578B => \u51CF\u5C11\u91CD\u8F7D")),e.a.createElement(t.a,{code:`type NameOrId<T extends number | string> = T extends number
  ? IdLabel
  : NameLabel;
...
// let c: NameLabel | IdLabel`,lang:"js"}),e.a.createElement("ul",null,e.a.createElement("li",null,"\u6761\u4EF6\u7C7B\u578B\u7EA6\u675F")),e.a.createElement(t.a,{code:`type MessageOf<T> = T extends { message: unknown } ? T["message"] : never;
...
// type Num = number`,lang:"js"}),e.a.createElement("ul",null,e.a.createElement("li",null,"infer")),e.a.createElement(t.a,{code:`- \u53EF\u4EE5\u4ECE\u6B63\u5728\u6BD4\u8F83\u7684\u7C7B\u578B\u4E2D\u63A8\u65AD\u7C7B\u578B\uFF0C\u7136\u540E\u5728 true \u5206\u652F\u91CC\u5F15\u7528\u8BE5\u63A8\u65AD\u7ED3\u679C
  - \u5728\u6761\u4EF6\u7C7B\u578B\u91CC\u63A8\u65AD
\`\`\`ts
// type Flatten<T> = T extends any[] ? T[number] : T;
...
// type StrArrOrNumArr = (string | number)[]`,lang:"js"}),e.a.createElement("h3",{id:"in"},e.a.createElement(n.AnchorLink,{to:"#in","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"in"),e.a.createElement(t.a,{code:`in \u5219\u53EF\u4EE5\u904D\u5386\u679A\u4E3E\u7C7B\u578B
type Keys = "a" | "b"
type Obj =  {
  [p in Keys]: any
} // -> { a: any, b: any }
...
console.log(isNumber(true)) //false`,lang:"js"}),e.a.createElement("h2",{id:"5inerface"},e.a.createElement(n.AnchorLink,{to:"#5inerface","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"5.inerface"),e.a.createElement(t.a,{code:`# base
interface IPerson {
...
}`,lang:"js"}),e.a.createElement("h2",{id:"6-\u6CDB\u578B"},e.a.createElement(n.AnchorLink,{to:"#6-\u6CDB\u578B","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"6. \u6CDB\u578B"),e.a.createElement(t.a,{code:`#
...
// type Modify<T, R> = Omit<T, keyof R> & R;`,lang:"ts"}),e.a.createElement("h4",{id:"deeppartial"},e.a.createElement(n.AnchorLink,{to:"#deeppartial","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"DeepPartial"),e.a.createElement(t.a,{code:`type DeepPartial<T> = {
  [K in keyof T]?: T[K] extends object ? DeepPartial<T[K]> : T[K];
};`,lang:"ts"}),e.a.createElement("h4",{id:"deeprequired"},e.a.createElement(n.AnchorLink,{to:"#deeprequired","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"DeepRequired"),e.a.createElement(t.a,{code:`type DeepRequired<T> = {
  [K in keyof T]-?: T[K] extends object ? DeepRequired<T[K]> : T[K];
};`,lang:"ts"}),e.a.createElement("h4",{id:"getcommonkeys"},e.a.createElement(n.AnchorLink,{to:"#getcommonkeys","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"GetCommonKeys"),e.a.createElement(t.a,{code:`// \u63D0\u53D6\u516C\u4F17\u5C5E\u6027
...
# \u7EC4\u4EF6\u5B9E\u4F8B \u89C1\u4E0B\u65B9`,lang:"js"}),e.a.createElement("h4",{id:"getderivedstatefromprops"},e.a.createElement(n.AnchorLink,{to:"#getderivedstatefromprops","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"getDerivedStateFromProps"),e.a.createElement(t.a,{code:`static getDerivedStateFromProps(
    props: Props,
    state: State
  ): Partial<State> | null {
    //
...
}`,lang:"ts"}),e.a.createElement("h4",{id:"defaultprops"},e.a.createElement(n.AnchorLink,{to:"#defaultprops","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"defaultProps"),e.a.createElement(t.a,{code:`// internal contract, should not be exported out
type GreetProps = {
  age: number;
};
...
}`,lang:"ts"}),e.a.createElement("h4",{id:"hook"},e.a.createElement(n.AnchorLink,{to:"#hook","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"hook"),e.a.createElement("ul",null,e.a.createElement("li",null,"\u7B2C\u4E00\u79CD\u65B9\u5F0F")),e.a.createElement(t.a,{code:`import React from 'react';
...
}`,lang:"js"}),e.a.createElement(t.a,{code:`import React from 'react';
...
export default Countdown;`,lang:"js"}),e.a.createElement("ul",null,e.a.createElement("li",null,"\u7B2C\u4E8C\u79CD\u65B9\u5F0F")),e.a.createElement(t.a,{code:`import React from 'react';
...
export default React.forwardRef(Countdown);`,lang:"js"}),e.a.createElement(t.a,{code:`import React from 'react';
...
};`,lang:"js"}),e.a.createElement("h4",{id:"vue3"},e.a.createElement(n.AnchorLink,{to:"#vue3","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"vue3"),e.a.createElement(t.a,{code:`<script setup lang="ts">
import xxx from './xxx'
const Child = ref<InstanceType<typeof xxx>>(null!)
</script>`,lang:"js"}),e.a.createElement("h2",{id:"bug"},e.a.createElement(n.AnchorLink,{to:"#bug","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"Bug"),e.a.createElement("h4",{id:"numbe-index-sign"},e.a.createElement(n.AnchorLink,{to:"#numbe-index-sign","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"numbe Index sign"),e.a.createElement(t.a,{code:`interface Animal {
  name: string;
}
...
interface NotOkay {
  ...
  [x: number]: Dog;
  [x: string]: Animal;
}`,lang:"ts"}),e.a.createElement("h4",{id:"tuple-assignment-parameters-error"},e.a.createElement(n.AnchorLink,{to:"#tuple-assignment-parameters-error","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"tuple assignment parameters error"),e.a.createElement(t.a,{code:`const args = [8, 5] as const;
const angle = Math.atan2(...args);`,lang:"ts"}),e.a.createElement("h4",{id:"double-assign"},e.a.createElement(n.AnchorLink,{to:"#double-assign","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"double assign"),e.a.createElement(t.a,{code:"as any as JSX.Element",lang:"js"}),e.a.createElement("h4",{id:"thissetstate"},e.a.createElement(n.AnchorLink,{to:"#thissetstate","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"this.setState"),e.a.createElement(t.a,{code:`// \u5982\u679C\u62A5\u9519 \u9700\u8981\u58F0\u660E\u63A5\u53E3
React.Component<IPorps,IStates>`,lang:"js"}),e.a.createElement("h4",{id:"objectindex"},e.a.createElement(n.AnchorLink,{to:"#objectindex","aria-hidden":"true",tabIndex:-1},e.a.createElement("span",{className:"icon icon-link"})),"ObjectIndex"),e.a.createElement(t.a,{code:`const props = {
  foo: "bar"
};
props["foo"] = "baz";
#
...
props["foo"] = "baz"; // ok
props["bar"] = "baz"; // error`,lang:"js"}))));u.default=r=>{const s=e.a.useContext(n.context),m=s.demos;return e.a.useEffect(()=>{var c;r!=null&&(c=r.location)!==null&&c!==void 0&&c.hash&&n.AnchorLink.scrollToAnchor(decodeURIComponent(r.location.hash.slice(1)))},[]),e.a.createElement(i,{demos:m})}}}]);
